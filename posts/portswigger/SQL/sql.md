...
According to the previous challenge we recoginzed the table name as this `USERS_XNIZHH`:
...
What the above sql code does is that it checks if a character exist at a particular index of the adminsitrator password column, if the statement  holds true it sleeps for 10 seconds and otherwise it doesn't sleep atall or for 0 seconds, we input this into the TrackingId feild parameter:

![1689922680651.png](1689922680651.png)
...
From our new found trick in the previous lab we could ping our dns server with the admin password, all we have to do is to append the queryed password into the subdomain of the dns url.
...
![1689926328502.png](1689926328502.png)

This the result of the ping, from the below picture we could see that the adminstrator password was appended as the subdomain, we could now use this information to login as admin.

![1689926367132.png](1689926367132.png)

After logging in:

![1689926474538.png](1689926474538.png)
...
![1689943006777.png](1689943006777.png)

Response recieved:

![1689943038343.png](1689943038343.png)

using the above information to login :

![1689943075984.png](1689943075984.png)
