...
![1694842313742.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694842313742.png)

we could see the admin route in the disallow route, now lets access it:
![1694842373083.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694842373083.png)

now we could solve the challenge by deleting the user carlos

![1694842423886.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694842423886.png)
...
![1694842611316.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694842611316.png)
...
![1694842693453.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694842693453.png)
...
![1694843029389.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694843029389.png)

![1694843046191.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694843046191.png)

we delete the required use and solved the lab

![1694843101597.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694843101597.png)
...
![1694843972459.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694843972459.png)

we enter the admin route and delete the user carlos

![1694844020189.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694844020189.png)
...
![1694844403651.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694844403651.png)

after sending the request we got this:

![1694844367629.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694844367629.png)

we sumbit the api key and solved the lab

![1694844446302.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694844446302.png)
...
![1694845472010.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694845472010.png)

and we got the api key below after submiting this request:

![1694845493766.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694845493766.png)

we submit the key and we solved the lab:
![1694845544119.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694845544119.png)
...
![1694846404247.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846404247.png)

Despite the redirect message we could see the api key in the redirect response:

![1694846388374.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846388374.png)

we submit the solution and solved the lab:

![1694846443601.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846443601.png)
...
![1694846723876.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846723876.png)

we checked the raw html and saw the password for carlos:

![1694846755994.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846755994.png)

we do the same for administrator and retrived the password for the admin:

![1694846949932.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846949932.png)

response of the sent request:

![1694846963616.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846963616.png)

we checked the raw html for the password:

![1694846983010.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694846983010.png)

Using the admins logins details we logged in and delete the user carlos:

![1694847044113.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694847044113.png)
...
![1694847454656.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694847454656.png)

we then send the payload and got the following response:

![1694847479357.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694847479357.png)

we use the password in the above graphic to log in and solved the lab

![1694847522871.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694847522871.png)
...
![1694847941244.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694847941244.png)

response of the above payload:

![1694847969079.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694847969079.png)

to delete a the required user carlos we then recraft the payload to this:

![1694848396623.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694848396623.png)

and we succesfully solved the lab:
![1694848412731.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694848412731.png)
...
![1694850322060.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694850322060.png)
...
![1694954040089.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694954040089.png)

Response of the sent payload:
![1694954059326.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694954059326.png)
...
![1694954410623.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694954410623.png)

Result after sending the payload:

![1694954443399.png](https://blog.cyb3rguru.tech/posts/portswigger/access_control/images/1694954443399.png)
